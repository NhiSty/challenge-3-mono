        ...
        <div className={'flex flex-row justify-between items-start'}>
          <Card classNames={'w-1/3 mr-4'}>
            <div className={'flex flex-col items-center'}>
              <h1 className={'text-3xl font-bold'}>{toTranslate('My company')}</h1>
              <table className={'table-auto mt-5'}>
                <tbody>
                <tr>
                  <td className={'px-4 py-2'}><strong>{toTranslate('Name')}</strong></td>
                  <td className={'px-4 py-2'}>{company?.company_name}</td>
                </tr>
                <tr>
                  <td className={'px-4 py-2'}><strong>{toTranslate('Address')}</strong></td>
                  <td className={'px-4 py-2'}>{company?.company_address}</td>
                </tr>
                <tr>
                  <td className={'px-4 py-2'}><strong>{toTranslate('Phone')}</strong></td>
                  <td className={'px-4 py-2'}>{company?.company_phone}</td>
                </tr>
                <tr>
                  <td className={'px-4 py-2'}><strong>{toTranslate('Email')}</strong></td>
          ...
          <Card classNames={'w-2/3'}>
            <div className={'flex flex-col items-center'}>
              <div className={'flex flex-row items-center justify-between w-full mb-5'}>
                <h1 className={'text-xl font-bold'}>{toTranslate('My franchises')}</h1>
                <button
