 ...
 */
final class Version20231028132805 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE report (id INT NOT NULL, reporter_id INT NOT NULL, reviewee_id INT NOT NULL, report_content TEXT NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_C42F7784E1CFE6F5 ON report (reporter_id)');
        $this->addSql('CREATE INDEX IDX_C42F7784BD992930 ON report (reviewee_id)');
        ...
        $this->addSql('ALTER TABLE report ADD CONSTRAINT FK_C42F7784BD992930 FOREIGN KEY (reviewee_id) REFERENCES "user" (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE report DROP CONSTRAINT FK_C42F7784BD992930');
