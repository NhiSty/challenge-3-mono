 ...
 */
final class Version20240213134532 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE booking (id INT NOT NULL, booker_id_id INT NOT NULL, booked_id_id INT NOT NULL, duration VARCHAR(255) NOT NULL, start_datetime TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
